document.addEventListener("DOMContentLoaded", () => {
    ...
    function drawCat(x,y) {
        ...
        // Draw the ears
        ctx3.beginPath();
        ctx3.moveTo(x-45, y-10);
        ctx3.lineTo(x-30, y-80);
        ctx3.lineTo(x, y-10);
        ctx3.fillStyle = "gray";
        ctx3.fill();
        ctx3.stroke();
        ...
        // Draw the eyes
        ctx3.beginPath();
        ctx3.arc(x-15, y-20, r/10, 0, Math.PI * 2, false);
        ...
        ctx3.lineTo(x-80, y-10);
        ctx3.fillStyle = "black";
        ctx3.fill();
        ctx3.stroke();
        ctx3.beginPath();
        ctx3.moveTo(x-50, y+5);
        ctx3.lineTo(x-80, y+5);
        ctx3.fillStyle = "black";
        ctx3.fill();
        ctx3.stroke();
        ctx3.beginPath();
        ctx3.moveTo(x-40, y+15);
        ctx3.lineTo(x-80, y+20);
        ctx3.fillStyle = "black";
        ctx3.fill();
        ctx3.stroke();
